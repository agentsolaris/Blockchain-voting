...
class Groth16 {
    ...
    async proof(signals, pkey) {
        console.log("pkey frotg " + pkey);
        const pkey32 = new Uint32Array(pkey,  pkey.byteOffset, pkey.byteLength / Uint32Array.BYTES_PER_ELEMENT);
        console.log("pkey frotg " + pkey32);
